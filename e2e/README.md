...
success. Per-gateway success rates for the three retained nodes were balanced:
`47.245.166.57:6776` reached `71/76`, `47.245.161.139:6776` reached `71/76`,
and `47.245.181.189:6776` reached `70/75`. All remaining failures were Etherscan
