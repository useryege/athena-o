...
import (
	...
	apisapplicationv1alpha1 "github.com/useryege/athena/pkg/apis/application/v1alpha1"
	versioned "github.com/useryege/athena/pkg/client/clientset/versioned"
	internalinterfaces "github.com/useryege/athena/pkg/client/informers/externalversions/internalinterfaces"
	applicationv1alpha1 "github.com/useryege/athena/pkg/client/listers/application/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.UseryegeV1alpha1().Applications(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.UseryegeV1alpha1().Applications(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.UseryegeV1alpha1().Applications(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.UseryegeV1alpha1().Applications(namespace).Watch(ctx, options)
			},
		}, client),
