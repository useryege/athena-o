...
import (
	...
	applicationv1alpha1 "github.com/useryege/athena/pkg/client/clientset/versioned/typed/application/v1alpha1"
...
type fakeApplications struct {
	*gentype.FakeClientWithList[*v1alpha1.Application, *v1alpha1.ApplicationList]
	Fake *FakeUseryegeV1alpha1
}

func newFakeApplications(fake *FakeUseryegeV1alpha1, namespace string) applicationv1alpha1.ApplicationInterface {
