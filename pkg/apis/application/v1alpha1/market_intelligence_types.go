...
type PolymarketFIFAMoneylineEventItem struct {
	...
	Teams         []*SportsTeamItem                    `protobuf:"bytes,15,rep,name=teams" json:"teams"`
	Options       []*PolymarketFIFAMoneylineOptionItem `protobuf:"bytes,16,rep,name=options" json:"options"`
}

type FIFAMarketDashboardWalletBalanceItem struct {
...
type FIFAMarketDashboardWalletHoldingItem struct {
