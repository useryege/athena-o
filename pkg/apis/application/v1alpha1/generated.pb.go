...
func (m *PolymarketDisputedMarketItem) Reset() { *m = PolymarketDisputedMarketItem{} }
...
func (m *PolymarketDisputedMarketItem) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PolymarketDisputedMarketItem) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PolymarketDisputedMarketItem) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	i = encodeVarintGenerated(dAtA, i, uint64(len(m.LastSeenAt)))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0xb2
	...
	i--
	dAtA[i] = 0x59
	i -= len(m.UMAResolutionStatuses)
	copy(dAtA[i:], m.UMAResolutionStatuses)
	i = encodeVarintGenerated(dAtA, i, uint64(len(m.UMAResolutionStatuses)))
	i--
	dAtA[i] = 0x52
	i -= len(m.UMAResolutionStatus)
	copy(dAtA[i:], m.UMAResolutionStatus)
	i = encodeVarintGenerated(dAtA, i, uint64(len(m.UMAResolutionStatus)))
	i--
	dAtA[i] = 0x4a
	i -= len(m.Image)
	copy(dAtA[i:], m.Image)
...
func (m *PolymarketDisputedMarketItem) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	l = len(m.Image)
	n += 1 + l + sovGenerated(uint64(l))
	l = len(m.UMAResolutionStatus)
	n += 1 + l + sovGenerated(uint64(l))
	l = len(m.UMAResolutionStatuses)
	n += 1 + l + sovGenerated(uint64(l))
	n += 9
	n += 9
	n += 9
...
func (this *PolymarketDisputedMarketItem) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PolymarketDisputedMarketItem{`,
		...
		`UMAResolutionStatus:` + fmt.Sprintf("%v", this.UMAResolutionStatus) + `,`,
		`UMAResolutionStatuses:` + fmt.Sprintf("%v", this.UMAResolutionStatuses) + `,`,
...
func (m *PolymarketDisputedMarketItem) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PolymarketDisputedMarketItem: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PolymarketDisputedMarketItem: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UMAResolutionStatus", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UMAResolutionStatus = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UMAResolutionStatuses", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UMAResolutionStatuses = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 11:
			if wireType != 1 {
