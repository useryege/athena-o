...
type WormPolyFIFAEventConfig struct {
...
type WormPolyFIFADashboard struct {
	Config                  *WormPolyFIFAEventConfig           `protobuf:"bytes,1,opt,name=config" json:"config"`
	WormEvent               *WormEventItem                     `protobuf:"bytes,2,opt,name=wormEvent" json:"wormEvent"`
	...
	WalletBalances          []*PolymarketFIFAWalletBalanceItem `protobuf:"bytes,8,rep,name=walletBalances" json:"walletBalances"`
	...
	WalletHoldings          []*PolymarketFIFAWalletHoldingItem `protobuf:"bytes,11,rep,name=walletHoldings" json:"walletHoldings"`
