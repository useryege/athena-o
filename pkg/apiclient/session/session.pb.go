...
type GetUserInfoResponse struct {
	...
	DataAccess            account.AccountDataAccess `protobuf:"varint,5,opt,name=dataAccess,proto3,enum=account.AccountDataAccess" json:"dataAccess,omitempty"`
	AuthorizationRevision uint64                    `protobuf:"varint,6,opt,name=authorizationRevision,proto3" json:"authorizationRevision,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                  `json:"-"`
	XXX_unrecognized      []byte                    `json:"-"`
	XXX_sizecache         int32                     `json:"-"`
}
...
func (m *GetUserInfoResponse) GetDataAccess() account.AccountDataAccess {
	if m != nil {
		return m.DataAccess
	}
...
func (m *GetUserInfoResponse) GetAuthorizationRevision() uint64 {
	if m != nil {
...
var fileDescriptor_8e8dbe1db8b11b5c = []byte{
	...
	,
}
...
func (m *GetUserInfoResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AuthorizationRevision != 0 {
		i = encodeVarintSession(dAtA, i, uint64(m.AuthorizationRevision))
		i--
		dAtA[i] = 0x30
	}
	if m.DataAccess != 0 {
		i = encodeVarintSession(dAtA, i, uint64(m.DataAccess))
		i--
		dAtA[i] = 0x28
	}
	if m.Administrator {
...
func (m *GetUserInfoResponse) Size() (n int) {
	...
	if m.DataAccess != 0 {
		n += 1 + sovSession(uint64(m.DataAccess))
	}
	if m.AuthorizationRevision != 0 {
		n += 1 + sovSession(uint64(m.AuthorizationRevision))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DataAccess |= account.AccountDataAccess(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AuthorizationRevision", wireType)
			}
			m.AuthorizationRevision = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowSession
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AuthorizationRevision |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
