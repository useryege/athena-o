...
/*
Package blocksniffer is a reverse proxy.
...
// RegisterBlockSnifferServiceHandlerServer registers the http handlers for service BlockSnifferService to "mux".
// UnaryRPC     :call BlockSnifferServiceServer directly.
...
// RegisterBlockSnifferServiceHandlerFromEndpoint is same as RegisterBlockSnifferServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterBlockSnifferServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterBlockSnifferServiceHandler(ctx, mux, conn)
}

// RegisterBlockSnifferServiceHandler registers the http handlers for service BlockSnifferService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterBlockSnifferServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterBlockSnifferServiceHandlerClient(ctx, mux, NewBlockSnifferServiceClient(conn))
}

// RegisterBlockSnifferServiceHandlerClient registers the http handlers for service BlockSnifferService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "BlockSnifferServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "BlockSnifferServiceClient"
