...
token-collector-wallet-funding-source-history: sh -c "GOCOVERDIR=${ATHENA_COVERAGE_DIR:-/tmp/coverage/athena-token-collector-wallet-funding-source-history} FORCE_LOG_COLORS=1 ATHENA_BINARY_NAME=athena-token-collector go run ./cmd/main.go --data-type wallet_funding_source_history"
