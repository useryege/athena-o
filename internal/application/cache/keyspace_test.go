...
func TestKeyspaceProjectKeys(t *testing.T) {
	...
	assertEqual(t, keys.ProjectBytecodeFact(chainID, contract), "application:project:56:"+contract.Hex()+":bytecode_fact")
	...
	assertEqual(t, keys.ProjectIndexBase(chainID), "application:index:project:56:base")
