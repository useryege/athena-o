...
// AccessRevocationAdapter borrows only the access caller's transaction.
type AccessRevocationAdapter struct{}

func NewAccessRevocationAdapter() *AccessRevocationAdapter { return &AccessRevocationAdapter{} }
...
func (s *AccessRevocationAdapter) RevokeTx(ctx context.Context, tx pgx.Tx, ownerID, reason string) error {
...
func (s *AccessRevocationAdapter) ApplyAccessChangeTx(ctx context.Context, tx pgx.Tx, ownerID string, previous, next accountaccess.Access) error {
