...
SELECT *,clock_timestamp() AS database_now FROM trader_sync_directory_refresh WHERE name='combo_markets' FOR UPDATE;
...
UPDATE trader_sync_directory_refresh SET cursor=sqlc.arg(next_cursor),
