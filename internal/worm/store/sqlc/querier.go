...
type Querier interface {
	...
	ListWormMarketsPendingMatchStartAnalysis(ctx context.Context) ([]ListWormMarketsPendingMatchStartAnalysisRow, error)
	Ping(ctx context.Context) (int32, error)
	SetWormMarketMatchStartAnalysisIfPending(ctx context.Context, arg SetWormMarketMatchStartAnalysisIfPendingParams) (int64, error)
