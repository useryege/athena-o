...
func (s *Service) updateSportsLiveScoreAlerts(ctx context.Context) {
	...
	for _, candidate := range candidates {
		...
		if err := s.store.UpdateSportsLiveScoreAlertState(ctx, sportslivestore.SportsLiveScoreAlertState{
...
func sportsLiveScoreAlertPresentation(candidate sportslivestore.SportsLiveScoreAlertCandidate) (string, string, string) {
