...
func executionRunStepToProto(step *wormstore.ExecutionRunStep) *apiclient.ExecutionRunStep {
	...
	result := &apiclient.ExecutionRunStep{
		...
		CompletionSource: string(step.CompletionSource), CompletionPositionPubkey: step.CompletionPositionPubkey,
		CompletionPositionRequestPubkey: step.CompletionPositionRequestPubkey,
		CompletionPositionCreatedAt:     executionPlanUnix(step.CompletionPositionCreatedAt),
