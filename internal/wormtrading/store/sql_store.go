...
var (
	...
	ErrWalletSelectionRevision              = fmt.Errorf("%w: wallet selection revision", ErrConflict)
	ErrWalletSelectionRetirementBlocked     = fmt.Errorf("%w: wallet selection retirement is blocked", ErrConflict)
	ErrWalletNotSelected                    = fmt.Errorf("%w: Wallet is not selected", ErrInvalidState)
	ErrWalletNotRetiring                    = fmt.Errorf("%w: Wallet is not retiring", ErrInvalidState)
	ErrWalletRetirementIncomplete           = fmt.Errorf("%w: Wallet retirement is incomplete", ErrConflict)
	ErrWalletConnectionCapacityPending      = fmt.Errorf("%w: Wallet connection capacity is pending", ErrConflict)
	ErrInvalidWalletSelection               = fmt.Errorf("%w: invalid wallet selection", ErrInvalidState)
	...
	ErrExecutionPlanWalletSelectionChanged  = fmt.Errorf("%w: execution plan Wallet selection changed", ErrConflict)
	...
	ErrExecutionRunWalletSelectionChanged   = fmt.Errorf("%w: execution wallet selection changed", ErrConflict)
