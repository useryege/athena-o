...
var uiBootstrapPermissions = []*session.ResourcePermission{
	...
	{Resource: rbac.ResourceTokenAPI, Action: rbac.ActionGet, Subresource: "project-research-states"},
	{Resource: rbac.ResourceTokenAPI, Action: rbac.ActionGet, Subresource: "project-report-revisions"},
	{Resource: rbac.ResourceTokenAPI, Action: rbac.ActionGet, Subresource: "project-selections"},
