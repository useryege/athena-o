...
type fifaWalletBalancesResult struct {
	items     []*v1alpha1.FIFAMarketDashboardWalletBalanceItem
	fetchedAt int64
}
...
func (s *Service) currentFIFAWalletBalances() ([]*v1alpha1.FIFAMarketDashboardWalletBalanceItem, int64) {
	s.cacheMu.RLock()
...
func initialFIFAWalletBalanceItems() []*v1alpha1.FIFAMarketDashboardWalletBalanceItem {
	message := fmt.Errorf("wallet balance refresh has not completed yet")
	return []*v1alpha1.FIFAMarketDashboardWalletBalanceItem{
...
func (s *Service) getFIFAPolygonPUSDBalance(ctx context.Context) *v1alpha1.FIFAMarketDashboardWalletBalanceItem {
...
func (s *Service) getFIFASolanaUSDCBalance(ctx context.Context) *v1alpha1.FIFAMarketDashboardWalletBalanceItem {
	item := baseFIFAWalletBalanceItem(
		fifaSolanaChain,
		fifaSolanaUSDCLabel,
		fifaSolanaUSDCToken,
...
func baseFIFAWalletBalanceItem(chain string, label string, walletAddress string, tokenAddress string, tokenSymbol string, decimals int32, explorerURL string) *v1alpha1.FIFAMarketDashboardWalletBalanceItem {
	return &v1alpha1.FIFAMarketDashboardWalletBalanceItem{
		Chain:         chain,
		Label:         label,
...
func markFIFAWalletBalanceError(item *v1alpha1.FIFAMarketDashboardWalletBalanceItem, err error) *v1alpha1.FIFAMarketDashboardWalletBalanceItem {
	item.OK = false
	item.RawAmount = "-"
	item.Amount = "-"
	if err != nil {
...
func cloneFIFAWalletBalanceItems(items []*v1alpha1.FIFAMarketDashboardWalletBalanceItem) []*v1alpha1.FIFAMarketDashboardWalletBalanceItem {
	cloned := make([]*v1alpha1.FIFAMarketDashboardWalletBalanceItem, 0, len(items))
