...
type Clientset interface {
	ProfitSharing() ProfitSharingServiceClient
...
type clientSet struct {
	...
	client     ProfitSharingServiceClient
}

func NewProfitSharingClientset(address string) (Clientset, error) {
	...
	return &clientSet{
		...
		client:     NewProfitSharingServiceClient(connection.ClientConn()),
	}, nil
}

func (c *clientSet) ProfitSharing() ProfitSharingServiceClient {
	return c.client
}
