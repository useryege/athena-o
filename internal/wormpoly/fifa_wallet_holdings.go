...
func (s *Service) currentFIFAWalletHoldings(requester string) ([]*v1alpha1.PolymarketFIFAWalletHoldingItem, int64, bool) {
	now := s.nowTime()
	interval := s.fifaWalletBalanceRefreshInterval
	if interval <= 0 {
		interval = defaultFIFAWalletBalanceRefreshInterval
...
func (s *Service) loadFIFAWalletHoldingsOnce(ctx context.Context, requester string) (fifaWalletHoldingsResult, error) {
	...
	items := make([]*v1alpha1.PolymarketFIFAWalletHoldingItem, 0, len(wallets))
...
func (s *Service) getFIFAWalletHolding(ctx context.Context, wallet *v1alpha1.WalletItem) *v1alpha1.PolymarketFIFAWalletHoldingItem {
...
func baseFIFAWalletHoldingItem(wallet *v1alpha1.WalletItem) *v1alpha1.PolymarketFIFAWalletHoldingItem {
	item := &v1alpha1.PolymarketFIFAWalletHoldingItem{
		Chain:         fifaWalletHoldingChainSolana,
		Type:          fifaWalletHoldingTypeWormPosition,
		SolRawAmount:  "0",
		SolAmount:     "0",
...
func markFIFAWalletHoldingError(item *v1alpha1.PolymarketFIFAWalletHoldingItem, message string) *v1alpha1.PolymarketFIFAWalletHoldingItem {
	item.OK = false
...
func cloneFIFAWalletHoldingItems(items []*v1alpha1.PolymarketFIFAWalletHoldingItem) []*v1alpha1.PolymarketFIFAWalletHoldingItem {
	cloned := make([]*v1alpha1.PolymarketFIFAWalletHoldingItem, 0, len(items))
