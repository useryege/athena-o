...
func (s *Service) moverAlertCandidateLocked(item *v1alpha1.MarketRadarMoverMarketItem, config MoverAlertsConfig, nowUnix int64) (moverAlertCandidate, bool) {
...
func moverAlertSeverity(item *v1alpha1.MarketRadarMoverMarketItem, config MoverAlertsConfig) string {
	leader := item.Leader
	if leader == nil {
		return ""
	}
...
func moverAlertKey(item *v1alpha1.MarketRadarMoverMarketItem, leader *v1alpha1.MarketRadarMoverTokenItem) string {
...
func moverWindowChange(token *v1alpha1.MarketRadarMoverTokenItem, label string) float64 {
	if token == nil {
		return 0
	}
...
func polymarketMoverLink(item *v1alpha1.MarketRadarMoverMarketItem) string {
