...
func (w *Worker) Start(ctx context.Context) error {
	...
	policies := map[research.DataCollectionType]time.Duration{research.DataCollectionTypeChainState: w.opts.ChainStateInterval, research.DataCollectionTypeWalletAssetState: w.opts.WalletAssetInterval, research.DataCollectionTypeSimulationResult: w.opts.SimulationInterval, research.DataCollectionTypeAve: w.opts.AveInterval, research.DataCollectionTypeContractCodeSource: w.opts.ContractSourceInterval}
