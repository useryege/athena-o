...
func simulateProjectWallets(ctx context.Context, rpcClient *rpc.Client, project catalog.Project, wallets []common.Address, states []athenacontract.AthenaSimulationState) ([]research.SimulationResultV1, error) {
	...
	for i, wallet := range wallets {
		offset := i * 6
		results = append(results, research.SimulationResultV1{
