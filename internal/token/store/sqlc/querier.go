...
type Querier interface {
	...
	CountProjectReports(ctx context.Context, arg CountProjectReportsParams) (int64, error)
	...
	ListDueProjectReportEvaluationTasks(ctx context.Context, limit int32) ([]ListDueProjectReportEvaluationTasksRow, error)
	...
	ListProjectReports(ctx context.Context, arg ListProjectReportsParams) ([]ListProjectReportsRow, error)
