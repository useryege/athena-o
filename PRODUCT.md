...
- 当前已确认后端设计并编写原后端计划，尚未实施。UI 各节已确认，完整书面 spec 待整体审阅；确认后更新前后端联合实现计划。资料查询、页面与运行结果不能因文档确认而记为已实现或验收通过。
...
- [UI spec：各节已确认，完整书面待审阅](docs/superpowers/specs/2026-09-10-trader-sync-activity-alerts-ui-design.md)
- [长期 UI 设计](docs/design/web-ui/trader-sync-activity-alerts.md)
- [后端实现计划，尚未执行](docs/superpowers/plans/2026-09-10-trader-sync-activity-alerts.md)
