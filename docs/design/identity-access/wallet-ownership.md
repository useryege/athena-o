...
> 范围修订（2026-09-16）：Worm Markets／Trading 保留，此前计划清理的 Worm 钱包选择、凭据和签名用途全部保留；ATHENA 钱包、EVM／Solana 托管、归属和资产也保留。详见[Sports 删除与 Worm 保留决定](../../requirements/development-runtime/sports-removal.md)。
