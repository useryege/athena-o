...
> 范围修订（2026-09-16）：Worm Markets 后续已独立退役，只保留 Worm Trading。钱包选择、Worm 凭据、purpose-bound signer、Run／Cash-Out proof、ATHENA 钱包及 EVM／Solana 托管、归属和资产全部保留；Markets 删除不撤销外部凭据或持仓。详见[Markets 退役需求](../../requirements/development-runtime/worm-markets-removal.md)。
