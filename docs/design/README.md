...
| Market Intelligence | Current Polymarket sports synchronization, price history, and price/score alerts | [Sports Live](market-intelligence/sports-live.md) | [删除已确认，尚未实施](../requirements/development-runtime/sports-removal.md)；现有代码仍在 |
| Market Intelligence | Completed ATP/WTA event synchronization, price history, status, and manual refresh | [Sports History](market-intelligence/sports-history.md) | [删除已确认，尚未实施](../requirements/development-runtime/sports-removal.md)；现有代码仍在 |
...
| Blockchain Data | Finalized inbound BSC transaction indexing and lookup | [BSC Inbound Normal Transactions](blockchain-data/bsc-inbound-normal-transactions.md) | [删除已确认，尚未实施](../requirements/blockchain-data/bsc-indexer-removal.md)；现有代码仍在 |
| Blockchain Data | Finalized BSC V2 Swap-topic transaction indexing and lookup | [BSC V2 Swap Transactions](blockchain-data/bsc-v2-swap-transactions.md) | [删除已确认，尚未实施](../requirements/blockchain-data/bsc-indexer-removal.md)；现有代码仍在 |
