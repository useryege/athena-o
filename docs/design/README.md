...
| Developer Experience | Public LLM discovery documents, one-time Connect AI instructions, Swagger generation and embedding, unauthenticated documentation delivery, and root-path and safety boundaries | [AI Discovery Documentation](developer-experience/ai-discovery-documentation.md) | `已退役，当前分支已验证`；退役路径、普通 API Key 与业务 Proto/gateway 保留，证据见[验收记录](../testing/swagger-ai-discovery-removal-acceptance.md) |
