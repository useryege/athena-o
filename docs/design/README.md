...
| Web UI | Google and Phantom login, provider-aware anonymous username setup, responsive shell, Pending-access experience, Connect AI, UUID-scoped caches, and administrator directory | [Application Shell](web-ui/application-shell.md) |
