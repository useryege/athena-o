...
| Web UI | Google and Phantom login, responsive shell, Pending access, custodial Wallet management, Worm Assets, Combinations, and Executions navigation, Connect AI, UUID-scoped caches, and administrator directory | [Application Shell](web-ui/application-shell.md) |
