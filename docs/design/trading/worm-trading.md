...
| Native combination facade | [internal/server/worm_combinations.go](../../../internal/server/worm_combinations.go), [internal/server/athena-server.go](../../../internal/server/athena-server.go) | `registerWormCombinationHandlers`, `getWormOrderEventCatalog`, combination CRUD handlers, `wormCombinationSelectionsToProto` |
| Trading combination resolution | [internal/wormtrading/market_combination_resolver.go](../../../internal/wormtrading/market_combination_resolver.go) | `resolveMarketCombinationItems`, authoritative current catalog validation and trusted snapshots |
