...
The process has its own executable, image, Compose project, PostgreSQL database, and persistent volume. It is independent of the main ATHENA process and the inbound BSC transaction indexer.
