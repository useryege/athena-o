...
The Ethereum fee-recipient address is `0xf38521f130fcCF29dB1961597bc5d2B60F995f85`; the BSC fee-recipient address is `0x0ED943Ce24BaEBf257488771759F9BF482C39706`. Runtime services obtain the deployed contract addresses from `ATHENA_TOKEN_ETH_ATHENA_CONTRACT` and `ATHENA_TOKEN_BSC_ATHENA_CONTRACT`, exposed as the corresponding `--eth-athena-contract` and `--bsc-athena-contract` command settings. The maintained [local](../../../.env) and [production](../../../.env.prod) configurations enable Ethereum Mainnet at `0x917559765849Fd7d49ed5794e7583E7AacCd0ef2` and disable BSC Mainnet while retaining its deployment at `0x372333a07c7b358Ef29187315e4FDF42Bc44FAC1`.
