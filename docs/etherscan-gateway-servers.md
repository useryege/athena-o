...
```bash
ETHERSCAN_GATEWAY_IPS='47.245.166.57 47.245.161.139 47.245.181.189 47.254.154.128'
```
...
```bash
ATHENA_ETHEREUM_API_ETHERSCAN_GATEWAY_ADDRS='47.245.166.57:6776 47.245.161.139:6776 47.245.181.189:6776 47.254.154.128:6776'
```
