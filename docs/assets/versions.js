...
window.addEventListener("DOMContentLoaded", function() {
  ...
  if (currentVersion && currentVersion !== "stable") {
    if (currentVersion === "latest") {
      document.querySelector("div[data-md-component=announce]").innerHTML = "<div id='announce-msg'>You are viewing the docs for an unreleased version of Athena, <a href='https://athena.readthedocs.io/en/stable/'>click here to go to the latest stable version.</a></div>";
    } else {
      document.querySelector("div[data-md-component=announce]").innerHTML = "<div id='announce-msg'>You are viewing the docs for a previous version of Athena, <a href='https://athena.readthedocs.io/en/stable/'>click here to go to the latest stable version.</a></div>";
    }
