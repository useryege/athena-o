...
Every commit to master is built and published to `ghcr.io/argoproj/argo-cd/athena:<version>-<short-sha>`. The list of images is available at
...
> to configure image pull secret if you want to use `ghcr.io/argoproj/argo-cd/athena` image.
