...
- [Trader Sync 产品需求](requirements/polymarket-copy-trading/README.md) — 首期按 10 人设计；后端已确认，UI 各节已确认、[完整书面待审阅](superpowers/specs/2026-09-10-trader-sync-activity-alerts-ui-design.md)，尚未实施；未来 Copy Trading 具体需求另行讨论。
