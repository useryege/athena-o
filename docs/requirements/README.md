...
| Service Operations | [Sports 删除与 Worm 保留](development-runtime/sports-removal.md) | `代码清理已实施`；现场状态见[验收记录](../testing/module-removal-cleanup-acceptance.md)；删除 Sports Live／History 与 World Cup Corners，专属历史数据直接删除；Worm Markets／Trading 及其数据保留 | [删除与清理配套设计](../superpowers/specs/2026-09-16-module-removal-cleanup-design.md)自查及补充已完成，[删除清理实施计划](../superpowers/plans/2026-09-16-module-removal-cleanup.md)已整理，代码清理已实施；现场状态见[验收记录](../testing/module-removal-cleanup-acceptance.md)；[Sports 现状](../design/market-intelligence/sports-live.md)、[界面现状](../design/web-ui/market-intelligence.md) |
