...
| 业务域 | 入口 | 状态 | 关联技术设计 |
| --- | --- | --- | --- |
| Developer Experience | [移除 Swagger 与 AI 接入展示](developer-experience/api-documentation-removal.md) | `需求与详细设计已确认`；保留普通 API Key，代码尚未移除；按用户要求交由新的 chat 在新 Git 分支实施 | [移除详细设计](../superpowers/specs/2026-09-18-swagger-ai-discovery-removal-design.md)、[当前实现](../design/developer-experience/ai-discovery-documentation.md) |
