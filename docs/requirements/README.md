...
| 业务域 | 入口 | 状态 | 关联技术设计 |
| --- | --- | --- | --- |
| Service Operations | [删除 Worm Markets，仅保留 Worm Trading](development-runtime/worm-markets-removal.md) | `删除范围、专属数据直接删除及方案 A 已确认`；按需市场目录归 Trading，Trading 功能与数据保留；尚未实施 | [内聚与退役设计](../superpowers/specs/2026-09-16-worm-trading-market-query-design.md)已整理，新增技术细节待整体审阅；逐步实施计划尚未编写 |
