...
| 业务域 | 入口 | 状态 | 关联技术设计 |
| --- | --- | --- | --- |
| Developer Experience | [移除 Swagger 与 AI 接入展示](developer-experience/api-documentation-removal.md) | `已实施，待人工复验`；保留普通 API Key、Proto、HTTP gateway 与真实 JSON 契约，退役路径及验证证据见[验收记录](../testing/swagger-ai-discovery-removal-acceptance.md) | [移除详细设计](../superpowers/specs/2026-09-18-swagger-ai-discovery-removal-design.md)、[当前实现](../design/developer-experience/ai-discovery-documentation.md) |
