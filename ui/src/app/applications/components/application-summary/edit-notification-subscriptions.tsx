...
export const NOTIFICATION_SUBSCRIPTION_ANNOTATION_PREFIX = 'notifications.useryege.io/subscribe';

export const NOTIFICATION_SUBSCRIPTION_ANNOTATION_REGEX = new RegExp(`^notifications\\.useryege\\.io/subscribe\\.[a-zA-Z-]{1,100}\\.[a-zA-Z-]{1,100}$`);
