...
test('github.com', () => {
    testExample(
        'https://github.com/argoproj/athena.git',
        'git@github.com:argoproj/athena.git',
        '024dee09f543ce7bb5af7ca50260504d89dfda94',
        'https://github.com/argoproj/athena',
        'https://github.com/argoproj/athena/commit/024dee09f543ce7bb5af7ca50260504d89dfda94',
    );
});
