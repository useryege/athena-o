...
export const SensitiveWriteScope = (props: {module: AccountDataModule; children: React.ReactNode}) => {
    ...
    const identity = JSON.stringify([authorization.user.iss || '', authorization.user.accountId, authorization.user.administrator, authorization.revision, props.module]);
