        ...
        <AppPage title='Help' subtitle='Operational reference links'>
            <Section title='Resources'>
                <Space className='help-resource-list' orientation='vertical'>
                    ...
                    <Button type='link' icon={<FileTextOutlined />} href='llms.txt' target='_blank' rel='noreferrer'>
                        LLM discovery (llms.txt)
                    </Button>
                    <Button type='link' icon={<SafetyCertificateOutlined />} href='docs/ai/safety.md' target='_blank' rel='noreferrer'>
