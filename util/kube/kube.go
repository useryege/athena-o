...
// 			// spec.selector.matchLabels to match spec.template.metadata.labels. This means Athena
...
// 					// our Athena labels to get defaulted by kubernetes, so we explicitly set the labels
// 					// for them (minus the Athena labels).
