...
Source: https://docs.worm.wtf/api-reference/margin/estimate-position

GET /margin/positions/estimate/
...
<ParamField type="string">
  Collateral amount for the estimate (decimal string).
</ParamField>
...
<Expandable title="Data fields">
  ...
  <ResponseField name="liquidation_price" type="string | null">
    Liquidation threshold price for this entry and leverage.
  </ResponseField>
</Expandable>
