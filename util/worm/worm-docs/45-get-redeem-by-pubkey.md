# Get redeem by pubkey

Source: https://docs.worm.wtf/api-reference/redeems/redeem-detail

GET /redeems/{pubkey}/
Retrieve a single redeem request by its public key.

## Path Parameters

<ParamField type="string">
  The public key of the redeem request to retrieve.
</ParamField>
