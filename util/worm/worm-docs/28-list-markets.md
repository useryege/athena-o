...
Source: https://docs.worm.wtf/api-reference/markets/list-markets
...
<ParamField type="string">
  Market list filter. Case-insensitive name; one of `OPEN`, `CLOSED`, `RESOLVED`, `NEWEST`, `ENDING_SOON`, `ENDED_RECENTLY`.
</ParamField>
