...
Source: https://docs.worm.wtf/api-reference/orders/submit-order

POST /orders/{pubkey}/submit/
Submit a signed order draft to place it on the orderbook.

## Path Parameters

<ParamField type="string">
  The public key of the order draft to submit.
</ParamField>

## Body Parameters

<ParamField type="string">
  Hex signature over the draft **`message`** from [Create order draft](/api-reference/orders/create-order-draft).
</ParamField>
