...
Source: https://docs.worm.wtf/api-reference/markets/market-trades
...
<Expandable title="Data fields">
  ...
  <ResponseField name="state" type="string">
    Trade lifecycle state: `created`, `in_process`, `done`, or `failed` (lowercased enum name). Public market trades are typically `done`.
  </ResponseField>
