...
Source: https://docs.worm.wtf/api-reference/markets/market-detail
...
<Expandable title="Data fields">
  ...
  <ResponseField name="config" type="object">
    Trading configuration for this market (always present on success). Exactly one shape is returned; see **`kind`** and the expandables below.
  </ResponseField>
</Expandable>
...
<Expandable title="config — hyperliquid (`kind`: `hyperliquid`)">
  ...
  <ResponseField name="max_leverage" type="string">
    Maximum leverage (decimal string).
  </ResponseField>
...
<ResponseExample>
  ```json 200 Orderbook (spot CLOB) theme={null}
  {
    "data": {
      ...
      "yes_outcome_label": "New York Knicks",
      "no_outcome_label": "Atlanta Hawks",
      "outcomes": [
  ...
  ```json 200 Polymarket margin theme={null}
  {
    "data": {
      ...
      "margin_enabled": true,
      "yes_outcome_label": "Candidate A wins",
      "no_outcome_label": "Candidate A does not win",
      "outcomes": [
