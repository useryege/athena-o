...
<Expandable title="Data fields">
  ...
  <ResponseField name="message" type="string">
    Exact UTF-8 message to sign. Format: `Create Worm API credential | Wallet: {wallet_address} | Nonce: {nonce}`. Must be passed unchanged to [Create API key](/api-reference/auth-keys/create).
  </ResponseField>
...
<ResponseExample>
  ```json 200 theme={null}
  {
    "data": {
      ...
      "message": "Create Worm API credential | Wallet: 11111111111111111111111111111111 | Nonce: nonce_f2d8a3c1",
