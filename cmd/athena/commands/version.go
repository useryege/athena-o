...
func NewVersionCmd(clientOpts *athenaclient.ClientOptions, serverVersion *version.VersionMessage) *cobra.Command {
	var (
		short  bool
		client bool
		output string
...
func getServerVersion(ctx context.Context, options *athenaclient.ClientOptions, c *cobra.Command) *version.VersionMessage {
