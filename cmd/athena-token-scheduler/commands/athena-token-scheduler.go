...
func NewCommand() *cobra.Command {
	...
	var chainStateInterval, walletAssetInterval, simulationInterval, walletFundingSourceHistoryRetryInterval, aveInterval, contractSourceInterval, researchTTL time.Duration
