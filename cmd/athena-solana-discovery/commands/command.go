...
func NewCommand() *cobra.Command {
	...
	f.StringVar(&c.DSN, "postgres-dsn", env.StringFromEnv("ATHENA_SOLANA_DISCOVERY_POSTGRES_DSN", postgres.DSN("ATHENA_SERVER_POSTGRES_DSN", "athena")), "PostgreSQL database containing Solana schema and account access")
