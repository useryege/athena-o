...
import (
	...
	"github.com/useryege/athena/internal/projectcontroller"
	"github.com/useryege/athena/internal/projectcontroller/apiclient"
	"github.com/useryege/athena/internal/projectcontroller/metrics"
...
const cliName = "athena-project-controller"
...
func NewCommand() *cobra.Command {
	...
	command := &cobra.Command{
		Use:               cliName,
		Short:             "Run the Athena Project Controller",
		Long:              "The Project Controller manages project-level workloads and state transitions. This command runs the service in the foreground.",
		DisableAutoGenTag: true,
		RunE: func(cmd *cobra.Command, _ []string) error {
			vers := common.GetVersion()
			vers.LogStartupInfo(
				"Athena Project Controller",
				map[string]any{
					"port": listenPort,
				},
			)
			...
			server := projectcontroller.NewServer()
