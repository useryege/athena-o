...
coverage_dirs=(
	...
	"/tmp/coverage/athena-token-profile-builder"
...
cleanup_athena_ports() {
	...
	local ports=(
		...
		"sports-history:${ATHENA_SPORTS_HISTORY_PORT:-8104}"
		"managed-oo:${ATHENA_MANAGED_OO_PORT:-8106}"
		"profit-sharing:${ATHENA_PROFIT_SHARING_PORT:-8108}"
		...
		"token-profile-builder-health:8118"
